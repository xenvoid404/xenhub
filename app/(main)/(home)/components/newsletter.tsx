...
export function Newsletter() {
    return (
        <section className="mt-8 mb-10 px-6 bg-muted/20">
                ...
                <Card className="rounded-2xl overflow-hidden text-center">
                    <CardHeader className="pt-10">
                        ...
                        <CardDescription className="max-w-md mx-auto pt-2">
                            Berlangganan newsletter kami dan dapatkan artikel, tips, dan sumber daya terbaru langsung di kotak masuk Anda.
                        </CardDescription>
                    </CardHeader>
